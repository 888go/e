...
// 返回值：
// float64：四舍五入后的结果
func X四舍五入(欲被四舍五入的数值 float64, 被舍入的位置 int) float64 {
	var pow float64 = 1
	for i := 0; i < 被舍入的位置; i++ {
		pow *= 10
	}
...
// 返回值：
// float64：求次方的结果
func X求次方(欲求次方数值 float64, 次方数 float64) float64 {
...
// 返回值：
// float64：求平方根的结果
func X求平方根(欲求平方根的数值 float64) float64 {
...
// 返回值：
// float64：角的正弦值
func X求正弦(欲进行计算的角 float64) float64 {
...
// 返回值：
// float64：角的余弦值
func X求余弦(欲进行计算的角 float64) float64 {
...
// 返回值：
// float64：角的正切值
func X求正切(欲进行计算的角 float64) float64 {
...
// 返回值：
// float64：数值的反正切值
func X求反正切(欲求其反正切值的数值 float64) float64 {
